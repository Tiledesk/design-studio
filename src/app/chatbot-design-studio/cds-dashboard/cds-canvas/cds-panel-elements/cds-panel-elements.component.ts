...
import { TYPE_CHATBOT, ACTIONS_LIST, TYPE_ACTION_CATEGORY, ACTION_CATEGORY, resolveChatbotSubtype } from 'src/app/chatbot-design-studio/utils-actions';
...
export class CdsPanelElementsComponent implements OnInit {
  ...
  createActionListByCategory(){
    ACTION_CATEGORY.forEach(category => {
      ...
      // Invoke Agent / Invoke Subagent incluse: un subagent puo' invocare un altro subagent.
