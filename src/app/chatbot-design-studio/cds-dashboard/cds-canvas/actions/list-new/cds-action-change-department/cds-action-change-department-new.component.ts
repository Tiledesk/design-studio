...
@Component({
  selector: 'cds-action-change-department-new',
  templateUrl: './cds-action-change-department-new.component.html',
  styleUrls: ['./cds-action-change-department-new.component.scss']
})
export class CdsActionChangeDepartmentNewComponent implements OnInit {
