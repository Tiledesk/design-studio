...
@Component({
  selector: 'cds-action-web-request-new',
  templateUrl: './cds-action-web-request-new.component.html',
  styleUrls: ['./cds-action-web-request-new.component.scss']
})
export class CdsActionWebRequestNewComponent implements OnInit {
