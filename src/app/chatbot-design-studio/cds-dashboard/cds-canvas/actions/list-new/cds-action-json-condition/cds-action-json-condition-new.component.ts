...
@Component({
  selector: 'cds-action-json-condition-new',
  templateUrl: './cds-action-json-condition-new.component.html',
  styleUrls: ['./cds-action-json-condition-new.component.scss']
})
export class CdsActionJsonConditionNewComponent implements OnInit {
