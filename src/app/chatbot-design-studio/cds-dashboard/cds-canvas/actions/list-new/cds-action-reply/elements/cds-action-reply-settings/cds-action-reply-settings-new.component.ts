...
@Component({
  selector: 'cds-action-reply-settings-new',
  templateUrl: './cds-action-reply-settings-new.component.html',
  styleUrls: ['./cds-action-reply-settings-new.component.scss']
})
export class CdsActionReplySettingsNewComponent implements OnInit {
