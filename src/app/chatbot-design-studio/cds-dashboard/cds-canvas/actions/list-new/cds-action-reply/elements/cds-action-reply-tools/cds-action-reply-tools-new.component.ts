...
@Component({
  selector: 'cds-action-reply-tools-new',
  templateUrl: './cds-action-reply-tools-new.component.html',
  styleUrls: ['./cds-action-reply-tools-new.component.scss']
})
export class CdsActionReplyToolsNewComponent implements OnInit {
