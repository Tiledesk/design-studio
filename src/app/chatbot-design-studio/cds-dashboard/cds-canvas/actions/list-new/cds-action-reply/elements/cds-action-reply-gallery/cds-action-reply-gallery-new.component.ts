...
@Component({
  ...
  templateUrl: './cds-action-reply-gallery-new.component.html',
  styleUrls: ['./cds-action-reply-gallery-new.component.scss']
})
export class CdsActionReplyGalleryNewComponent implements OnInit, AfterViewInit, OnDestroy {
