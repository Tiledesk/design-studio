...
@Component({
  selector: 'cds-action-reply-text-new',
  templateUrl: './cds-action-reply-text-new.component.html',
  styleUrls: ['./cds-action-reply-text-new.component.scss']
})
export class CdsActionReplyTextNewComponent implements OnInit {
