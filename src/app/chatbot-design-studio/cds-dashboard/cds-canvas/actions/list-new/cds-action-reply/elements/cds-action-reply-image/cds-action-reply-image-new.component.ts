...
@Component({
  selector: 'cds-action-reply-image-new',
  templateUrl: './cds-action-reply-image-new.component.html',
  styleUrls: ['./cds-action-reply-image-new.component.scss']
})
export class CdsActionReplyImageNewComponent implements OnInit {
