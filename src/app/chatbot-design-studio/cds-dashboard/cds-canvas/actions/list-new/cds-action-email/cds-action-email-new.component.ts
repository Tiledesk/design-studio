import { ActionEmail } from 'src/app/models/action-model';
import { Component, OnInit, Input, ElementRef, OnChanges, Output, EventEmitter } from '@angular/core';
import { LoggerService } from 'src/chat21-core/providers/abstract/logger.service';
import { LoggerInstance } from 'src/chat21-core/providers/logger/loggerInstance';

@Component({
  selector: 'cds-action-email-new',
  templateUrl: './cds-action-email-new.component.html',
  styleUrls: ['./cds-action-email-new.component.scss']
})
export class CdsActionEmailNewComponent implements OnInit, OnChanges {
