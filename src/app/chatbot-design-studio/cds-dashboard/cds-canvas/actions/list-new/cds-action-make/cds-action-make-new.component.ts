...
@Component({
  selector: 'cds-action-make-new',
  templateUrl: './cds-action-make-new.component.html',
  styleUrls: ['./cds-action-make-new.component.scss']
})
export class CdsActionMakeNewComponent implements OnInit {
