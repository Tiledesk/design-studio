...
@Component({
  selector: 'cds-action-ai-condition-new',
  templateUrl: './cds-action-ai-condition-new.component.html',
  styleUrls: ['./cds-action-ai-condition-new.component.scss']
})
export class CdsActionAiConditionNewComponent implements OnInit {
