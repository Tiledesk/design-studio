...
@Component({
  selector: 'cds-action-open-hours-new',
  templateUrl: './cds-action-open-hours-new.component.html',
  styleUrls: ['./cds-action-open-hours-new.component.scss']
})
export class CdsActionOpenHoursNewComponent implements OnInit {
