...
@Component({
  selector: 'cds-action-assign-function-new',
  templateUrl: './cds-action-assign-function-new.component.html',
  styleUrls: ['./cds-action-assign-function-new.component.scss']
})
export class CdsActionAssignFunctionNewComponent implements OnInit {
