...
@Component({
  selector: 'cds-action-askgpt-v2-new',
  templateUrl: './cds-action-askgpt-v2-new.component.html',
  styleUrls: ['./cds-action-askgpt-v2-new.component.scss']
})
export class CdsActionAskgptV2Component implements OnInit, OnChanges {
  ...
  setModel(
    ...
    if (result) {
      ...
      const modelMin = result.min_tokens;
