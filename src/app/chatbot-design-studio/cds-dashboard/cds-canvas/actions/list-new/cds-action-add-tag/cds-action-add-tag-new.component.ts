...
@Component({
  selector: 'cds-action-add-tag-new',
  templateUrl: './cds-action-add-tag-new.component.html',
  styleUrls: ['./cds-action-add-tag-new.component.scss']
})
export class CdsActionAddTagNewComponent implements OnInit {
