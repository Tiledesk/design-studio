...
@Component({
  selector: 'appdashboard-mcp-server-edit-dialog-new',
  templateUrl: './mcp-server-edit-dialog-new.component.html',
  styleUrls: ['./mcp-server-edit-dialog-new.component.scss']
})
