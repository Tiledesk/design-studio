...
@Component({
  selector: 'cds-action-ai-prompt-new',
  templateUrl: './cds-action-ai-prompt-new.component.html',
  styleUrls: ['./cds-action-ai-prompt-new.component.scss']
})
export class CdsActionAiPromptNewComponent implements OnInit, OnChanges {
