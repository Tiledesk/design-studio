...
@Component({
  selector: 'cds-action-intent-new',
  templateUrl: './cds-action-intent-new.component.html',
  styleUrls: ['./cds-action-intent-new.component.scss']
})
export class CdsActionIntentNewComponent implements OnInit {
