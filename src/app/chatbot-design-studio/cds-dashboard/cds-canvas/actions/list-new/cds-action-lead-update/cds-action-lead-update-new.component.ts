...
@Component({
  selector: 'cds-action-lead-update-new',
  templateUrl: './cds-action-lead-update-new.component.html',
  styleUrls: ['./cds-action-lead-update-new.component.scss']
})
export class CdsActionLeadUpdateNewComponent implements OnInit {
