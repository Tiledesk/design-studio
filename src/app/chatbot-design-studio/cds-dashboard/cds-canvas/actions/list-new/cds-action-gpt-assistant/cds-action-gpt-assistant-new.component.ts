...
@Component({
  selector: 'cds-action-gpt-assistant-new',
  templateUrl: './cds-action-gpt-assistant-new.component.html',
  styleUrls: ['./cds-action-gpt-assistant-new.component.scss']
})
export class CdsActionGptAssistantNewComponent implements OnInit {
