...
@Component({
  selector: '  selector: 'cds-action-qapla-new',-new',
  templateUrl: './cds-action-qapla-new.component.html',
  styleUrls: ['./cds-action-qapla-new.component.scss']
})
export class CdsActionQaplaNewComponent implements OnInit {
