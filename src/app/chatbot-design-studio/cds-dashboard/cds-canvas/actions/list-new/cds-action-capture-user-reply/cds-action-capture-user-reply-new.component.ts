...
@Component({
  selector: 'cds-action-capture-user-reply-new',
  templateUrl: './cds-action-capture-user-reply-new.component.html',
  styleUrls: ['./cds-action-capture-user-reply-new.component.scss']
})
export class CdsActionCaptureUserReplyNewComponent implements OnInit {
