...
@Component({
  selector: 'cds-action-connect-block-new',
  templateUrl: './cds-action-connect-block-new.component.html',
  styleUrls: ['./cds-action-connect-block-new.component.scss']
})
export class CdsActionConnectBlockNewComponent implements OnInit {
