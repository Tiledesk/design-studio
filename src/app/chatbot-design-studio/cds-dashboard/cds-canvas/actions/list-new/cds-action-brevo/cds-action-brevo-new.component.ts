...
@Component({
  selector: 'cds-action-brevo-new',
  templateUrl: './cds-action-brevo-new.component.html',
  styleUrls: ['./cds-action-brevo-new.component.scss']
})
export class CdsActionBrevoNewComponent implements OnInit {
  ...
  private updateConnector(){
    this.logger.log('[ACTION-BREVO] updateConnector:');
    ...
    if(resp){
      ...
      this.idConnectionTrue   = resp.idConnectionTrue;
      this.idConnectionFalse  = resp.idConnectionFalse;
      this.logger.log('[ACTION-BREVO] updateConnector:', resp);
      if (resp.emit) {
