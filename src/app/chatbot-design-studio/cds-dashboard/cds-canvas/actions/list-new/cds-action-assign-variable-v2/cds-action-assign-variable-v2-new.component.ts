...
@Component({
  selector: 'cds-action-assign-variable-v2-new',
  templateUrl: './cds-action-assign-variable-v2-new.component.html',
  styleUrls: ['./cds-action-assign-variable-v2-new.component.scss']
})
