...
@Component({
    selector: 'cds-action-assign-variable-new',
    templateUrl: './cds-action-assign-variable-new.component.html',
    styleUrls: ['./cds-action-assign-variable-new.component.scss']
})
export class CdsActionAssignVariableNewComponent implements OnInit, OnChanges {
