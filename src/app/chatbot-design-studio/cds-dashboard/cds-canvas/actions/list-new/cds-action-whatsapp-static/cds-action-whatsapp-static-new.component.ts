...
@Component({
  selector: 'cds-action-whatsapp-static-new',
  templateUrl: './cds-action-whatsapp-static-new.component.html',
  styleUrls: ['./cds-action-whatsapp-static-new.component.scss']
})
export class CdsActionWhatsappStaticNewComponent implements OnInit {
