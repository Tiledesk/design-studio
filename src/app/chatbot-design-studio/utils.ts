...
export const ACTIONS_LIST: {[key: string]: {name: string, category: TYPE_ACTION_CATEGORY, type: TYPE_ACTION | TYPE_ACTION_VXML, src: string, status: 'active' | 'inactive' | 'beta', plan?: PLAN_NAME, description?: string, doc?: string, disabled?: boolean}}= {
    ...
    GPT_ASSISTANT:          { name: 'CDSActionList.NAME.GPTAssistant',          category: TYPE_ACTION_CATEGORY.INTEGRATIONS,        type: TYPE_ACTION.GPT_ASSISTANT,        src: "assets/images/actions/openai-assistent.svg",      status: "beta",                       description: "CDSActionList.DESCRIPTION.GPTAssistant",          doc: "CDSActionList.DOCS.GPTAssistant"          },
