...
export const ACTIONS_LIST: {[key: string]: {name: string, category: TYPE_ACTION_CATEGORY, type: TYPE_ACTION | TYPE_ACTION_VXML, src: string, status: 'active' | 'inactive' | 'beta', plan?: PLAN_NAME, description?: string, doc?: string, disabled?: boolean}}= {
    ...
    ASKGPT:                 { name: 'CDSActionList.NAME.AskTheKnowledgeBase',   category: TYPE_ACTION_CATEGORY.INTEGRATIONS,        type: TYPE_ACTION.ASKGPT,               src: "assets/images/actions/ask_to_kb.svg",             status: "inactive",                     description: "CDSActionList.DESCRIPTION.AskTheKnowledgeBase"                                                    },
    ASKGPTV2:               { name: 'CDSActionList.NAME.AskTheKnowledgeBase',   category: TYPE_ACTION_CATEGORY.INTEGRATIONS,        type: TYPE_ACTION.ASKGPTV2,             src: "assets/images/actions/ask_to_kb.svg",             status: "active",                       description: "CDSActionList.DESCRIPTION.AskTheKnowledgeBase"                                                    },
    ...
    GPT_ASSISTANT:          { name: 'CDSActionList.NAME.GPTAssistant',          category: TYPE_ACTION_CATEGORY.INTEGRATIONS,        type: TYPE_ACTION.GPT_ASSISTANT,        src: "assets/images/actions/openai-assistent.svg",      status: "active",                       description: "CDSActionList.DESCRIPTION.GPTAssistant",          doc: "CDSActionList.DOCS.GPTAssistant"          },
