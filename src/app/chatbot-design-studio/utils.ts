...
export const GROQ_MODEL: Array<{ name: string, value: string, description:string, status: "active" | "inactive"}> = [
    { name: "Llama3-70b",         value: "llama3-70b-8192",         description: "TYPE_GPT_MODEL.text-davinci-003.description",         status: "active" },
    { name: "Llama3-8b",          value: "llama3-8b-8192",          description: "TYPE_GPT_MODEL.text-davinci-003.description",         status: "active" },
    { name: "Llama-3.1-8b",       value: "llama-3.1-8b-instant",    description: "TYPE_GPT_MODEL.text-davinci-003.description",         status: "active" },
    { name: "Llama-3.1-70b",      value: "llama-3.1-70b-versatile", description: "TYPE_GPT_MODEL.text-davinci-003.description",         status: "inactive" },
    { name: "Mixtral-8x7b",       value: "Mixtral-8x7b-32768",      description: "TYPE_GPT_MODEL.text-davinci-003.description",         status: "active" },
