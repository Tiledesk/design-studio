...
export const ACTIONS_LIST: {[key: string]: {name: string, category: TYPE_ACTION_CATEGORY, type: TYPE_ACTION, src: string, status: 'active' | 'inactive' | 'beta', plan?: PLAN_NAME, description?: string, disabled?: boolean}}= {
    ...
    CODE : { name: 'CDSActionList.NAME.Code',category: TYPE_ACTION_CATEGORY.SPECIAL, type: TYPE_ACTION.CODE, src:"assets/images/actions/code.svg", status: "inactive", plan: PLAN_NAME.F, description: '', disabled: false},
