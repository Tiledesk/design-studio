export var voiceProviderList: Array<{key: string, label: string, elements?: Array<any>,  tts_voice?: Array<any>,  tts_model?: Array<any>, stt_model?: Array<any>}> = [ 
    ...
    },
    {
        ...
        label: "ElevenLabs",
        tts_voice: [
            { voiceId: '21m00Tcm4TlvDq8ikWAM', name: 'Rachel',    type: 'female, calm',       status: 'active' },
            { voiceId: 'AZnzlk1XvdvUeBnXmlld', name: 'Domi',      type: 'female, strong',     status: 'active' },
            { voiceId: 'EXAVITQu4vr4xnSDxMaL', name: 'Bella',     type: 'female, soft',       status: 'active' },
            { voiceId: 'MF3mGyEYCl7XYWbV9V6O', name: 'Elli',      type: 'female, emotional',  status: 'active' },
            { voiceId: 'XrExE9yKIg1WjnnlVkGX', name: 'Matilda',   type: 'female, warm',       status: 'active' },
            { voiceId: 'XB0fDUnXU5powFXDhCwa', name: 'Charlotte', type: 'female, Swedish',    status: 'active' },
            { voiceId: 'LcfcDJNUP1GQjkzn1xUU', name: 'Emily',     type: 'female, calm',       status: 'active' },
            { voiceId: 'ThT5KcBeYPX3keUQqHPh', name: 'Dorothy',   type: 'female, British',    status: 'active' },
            { voiceId: 'pFZP5JQG7iQjIQuC4Biku', name: 'Lily',     type: 'female, British',    status: 'active' },
            { voiceId: 'pMsXgVXv3BLzUgSXRplE', name: 'Serena',    type: 'female, pleasant',   status: 'active' },
            { voiceId: 'piTKgcLEGmPE4e6mEKli', name: 'Nicole',    type: 'female, whispering', status: 'active' },
            { voiceId: 'jsCqWAovK2LkecY7zXl4', name: 'Freya',     type: 'female, strong',     status: 'active' },
            { voiceId: 'oWAxZDx7w5VEj9dCyTzz', name: 'Grace',     type: 'female, Southern',   status: 'active' },
            { voiceId: 'ErXwobaYiN019PkySvjV',  name: 'Antoni',    type: 'male, balanced',     status: 'active' },
            { voiceId: 'TxGEqnHWrfWFTfGW9XjX',  name: 'Josh',      type: 'male, deep',         status: 'active' },
            { voiceId: 'VR6AewLTigWG4xSOukaG',  name: 'Arnold',    type: 'male, crisp',        status: 'active' },
            { voiceId: 'pNInz6obpgDQGcFmaJgB',  name: 'Adam',      type: 'male, deep',         status: 'active' },
            { voiceId: 'yoZ06aMxZJJ28mfd3POQ',  name: 'Sam',       type: 'male, raspy',        status: 'active' },
            { voiceId: 'IKne3meq5aSn9XLyUdCD',  name: 'Charlie',   type: 'male, Australian',   status: 'active' },
            { voiceId: 'JBFqnCBsd6RMkjVDRZzb',  name: 'George',    type: 'male, warm, British',status: 'active' },
            { voiceId: 'N2lVS1w4EtoT3dr4eOWO',  name: 'Callum',    type: 'male, intense',      status: 'active' },
            { voiceId: 'ZQe5CZNOzWyzPSCn5a3c',  name: 'James',     type: 'male, Australian',   status: 'active' },
            { voiceId: 'Zlb1dXrM653N07WRdFW3',  name: 'Joseph',    type: 'male, British',      status: 'active' },
            { voiceId: 'onwK4e9ZLuTAKqWW03F9',  name: 'Daniel',    type: 'male, deep, British',status: 'active' },
            { voiceId: 'pqHfZKP75CvOlQylNhV4',  name: 'Bill',      type: 'male, strong',       status: 'active' },
            { voiceId: 'flq6f7ib4F8Envnc5kGe',  name: 'Michael',   type: 'male, older',        status: 'active' },
            { voiceId: 'TX3LPaxmHKxFdv7VOQHJ',  name: 'Liam',      type: 'male, neutral',      status: 'active' },
            { voiceId: 'GBv7mTt0atIp3Br8iCZE',  name: 'Thomas',    type: 'male, calm',         status: 'active' },
            { voiceId: 'SOYHLrjzK2X1ezoPC6cr',  name: 'Harry',     type: 'male, anxious',      status: 'active' },
            { voiceId: 'g5CIjZEefAph4nQFvHAz',  name: 'Ethan',     type: 'male, ASMR',         status: 'active' },
        ],
        tts_model: [
            { model: 'eleven_flash_v2_5',       name: 'Flash v2.5',         type: 'fastest, real-time', status: 'active' },
            { model: 'eleven_multilingual_v2',  name: 'Multilingual v2',    type: 'high quality, 29 languages', status: 'active' },
            { model: 'eleven_v3',               name: 'v3',                 type: 'best quality, HTTP only', status: 'active' },
            { model: 'eleven_turbo_v2_5',       name: 'Turbo v2.5',         type: 'fast, 32 languages', status: 'active' },
            { model: 'eleven_flash_v2',         name: 'Flash v2',           type: 'fast, English', status: 'active' },
            { model: 'eleven_turbo_v2',         name: 'Turbo v2',           type: 'fast, English only', status: 'active' },
            { model: 'eleven_monolingual_v1',   name: 'Monolingual v1',     type: 'legacy, English only', status: 'active' },
        ],
        stt_model: [
            { model: 'scribe_v2_realtime',      name: 'Scribe v2 Realtime', type: 'streaming', status: 'active' },
            { model: 'scribe_v1',               name: 'Scribe v1',          type: 'standard',  status: 'active' },
            { model: 'scribe_v1_experimental',  name: 'Scribe v1 Experimental', type: 'experimental', status: 'active' },
        ]
    },
]