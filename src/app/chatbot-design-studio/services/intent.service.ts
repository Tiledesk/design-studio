...
export class IntentService {
  ...
  */
  ...
  public createNewAction(typeAction: TYPE_ACTION | TYPE_ACTION_VXML) {
    ...
    if(typeAction === TYPE_ACTION.UPDATE_LEAD) {
      action = new ActionUpdateLead();
      action.assignStatusTo = 'updatedlead_status';
      action.assignErrorTo = 'updatedlead_error';
    }
