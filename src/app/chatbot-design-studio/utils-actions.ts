...
export enum TYPE_ACTION {
    ...
    INVOKE_SUB_AGENT_V2 = 'invoke_subagent_v2',
    RETURN              = 'return'
}
...
export const ACTIONS_LIST: {
    ...
    INVOKE_SUBAGENT:        { name: 'CDSActionList.NAME.InvokeSubagent',      chatbot_types: [TYPE_CHATBOT.CHATBOT, TYPE_CHATBOT.WEBHOOK, TYPE_CHATBOT.COPILOT],                                                   category: TYPE_ACTION_CATEGORY.FLOW,                type: TYPE_ACTION.INVOKE_SUB_AGENT_V2,  src: "assets/images/actions/replace_bot.svg",           status: "active",   badge: 'NEW',          doc: "CDSActionList.DOC.InvokeSubagent"                              },
